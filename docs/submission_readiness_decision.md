...
Honest strongest claim: `Replace next-action decoding with energy-ranked feasible action manifolds.` is a plausible branch-structured mechanism for energy-based transformer robot policies, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
