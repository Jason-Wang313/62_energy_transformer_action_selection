...
1. Chosen thesis: Energy Transformer Action Selection explores `Replace next-action decoding with energy-ranked feasible action manifolds.` for energy-based transformer robot policies.
...
8. Exact Downloads PDF path: `C:/Users/wangz/Downloads/62.pdf`
9. GitHub URL: https://github.com/Jason-Wang313/62_energy_transformer_action_selection
